...
const friction = 0.7; // how much the player is slowed each frame
const maxSpeed = 16; // maximum horizontal speed, not vertical
const playerJumpStrength = 25; // this is subtracted from the speedY each jump
